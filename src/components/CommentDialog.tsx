...
function CommentDialog({ interviewId }: { interviewId: Id<"interviews"> }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-xl w-[90%]">
        <DialogHeader className="text-center">
          <DialogTitle className="text-xl">Interview Comment</DialogTitle>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={rating} onValueChange={setRating}>
                <SelectTrigger className="mx-auto max-w-[200px]">
            ...
            {/* COMMENT */}
            <div className="space-y-2">
              <Label className="text-center block">Your Comment</Label>
              <Textarea
                value={comment}
        ...
        {/* BUTTONS */}
        <DialogFooter className="flex justify-center gap-2 sm:gap-0 pt-4">
