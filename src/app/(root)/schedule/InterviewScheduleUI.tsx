        ...
        <div className="container max-w-7xl mx-auto p-6 space-y-8">
            <div className="flex items-center justify-between">
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                    ...
                    <DialogContent className="sm:max-w-[500px] h-[calc(100vh-200px)] overflow-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <DialogHeader>
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            <div className="space-y-2 relative">
                                ...
                                >
                                    ...
                                    <SelectContent sideOffset={5} position="popper" className="z-[9999]">
